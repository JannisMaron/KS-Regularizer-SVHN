...
class SVHN_PreAct(nn.Module):
    def __init__(self, latent_dim, extra_layer=True, reg_latent=True):
        super(SVHN_PreAct, self).__init__()

        assert not (not extra_layer and reg_latent), "Cannot regularize on latent space without extra layer"
